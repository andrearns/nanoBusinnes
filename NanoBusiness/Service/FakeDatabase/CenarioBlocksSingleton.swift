    ...
    private init() {
        cenarioBlocks = [
            ...
            CenarioBlock(
                ...
                rightNode: CenarioNode(size: CGSize.init(width: 287.227, height: 222.333), texture: SKTexture(imageNamed: "paredeEstalactiteDireita"), afterCollisionTexture: SKTexture(imageNamed: "paredeGameOverDireita"), categoryMask: 1, collisionMask: 0, contactMask: 0)
            ),
            //1
            CenarioBlock(
                leftNode: CenarioNode(size: CGSize.init(width: 287.227, height: 222.333), texture: SKTexture(imageNamed: "paredeEstalactiteEsquerda"), afterCollisionTexture: SKTexture(imageNamed: "paredeGameOverEsquerda"), categoryMask: 1, collisionMask: 0, contactMask: 0),
